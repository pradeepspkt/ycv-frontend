...
const EducationalContent: React.FC<Props> = ({
  ...
  const goToNext = async () => {
    ...
    let blogTemp: any = []
    await fetch(
      'https://us-central1-yourcryptovoice-a9117.cloudfunctions.net/getContent?category=educational&startAfter=' +
  ...
  const goToPrev = async () => {
    ...
    let blogTemp: any = []
    await fetch(
      'https://us-central1-yourcryptovoice-a9117.cloudfunctions.net/getContent?category=educational&startAt=' +
  ...
  return (
    <>
      <PageTitle breadcrumbs={[]}>YCV's Learning Center</PageTitle>
      <div className='row'>
        {loading == 1 ? (
          renderBlogs
        ) : (
